...
Configuration DeploySQLServer
{
  param (  
   ...
   [System.Management.Automation.PSCredential] $SQLServerAcct,
   [parameter(Mandatory=$true)]
   [System.Management.Automation.PSCredential] $SQLAgentAcct,
   [parameter(Mandatory=$true)]
        ...
        Script ConfigureStartupJob {
            ...
            SetScript = {
                if($(test-path -path C:\SQLStartup) -eq $true) {
                    ...
                    $WebClient.DownloadFile($($Using:scriptFolderUrl) + "SQL-Startup.ps1","C:\SQLStartup\SQL-Startup.ps1")
        ...
        Script ConfigureExtendedSprocs {
            ...
            SetScript = {
                if($(test-path -path C:\SQLStartup) -eq $true) {
                    ...
                    $WebClient = New-Object System.Net.WebClient
                    $WebClient.DownloadFile($($Using:scriptFolderUrl) + "PostConfiguration.sql","C:\SQLStartup\PostConfiguration.sql")
            ...
            SetScript = {
                ...
                if($sqlInstances -ne $null){
                    try {                            
                        ...
                        $NtLogin = $($using:SQLServerAccount) 
